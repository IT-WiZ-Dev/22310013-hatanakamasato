...
public abstract class BaseBoardInformation {
	...
	public void checkClickedHoldKoma(boolean _firstSecond, int id) {
		//クリックした持ち駒は手番か
	...
	protected boolean isForcingPromoted(KomaPromoted kp, int gotoY) {
		//歩と香車の場合
		if(kp.getId() == 8 || kp.getId() == 6) {
